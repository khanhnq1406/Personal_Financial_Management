...
func TestTableDetector_GroupElementsByRow(t *testing.T) {
	elements := []TextElement{
		...
		{X: 10, Y: 120, Text: "01/01/2026"},
		{X: 50, Y: 120, Text: "Coffee"},
		{X: 150, Y: 120, Text: "50,000"},
		{X: 10, Y: 140, Text: "02/01/2026"},
	...
	assert.Equal(t, "01/01/2026", rows[1][0].Text)
}
...
func TestTableDetector_FindHeaderRow(t *testing.T) {
	tableRows := []TableRow{
		...
		{Cells: []string{"01/01/2026", "Coffee", "50,000"}},
		{Cells: []string{"02/01/2026", "Lunch", "100,000"}},
	}
