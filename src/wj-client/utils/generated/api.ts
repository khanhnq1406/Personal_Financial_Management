...
// Generated at: 2026-02-12T04:57:43.371Z
...
export const api = {
  ...
  import: {
    ...
    async undoImport(request: UndoImportRequest): Promise<UndoImportResponse> {
      ...
      const body = { null: request.null };
      return apiClient.post(endpoint, body) as unknown as UndoImportResponse;
    },
    ...
    async cancelJob(request: CancelJobRequest): Promise<CancelJobResponse> {
      ...
      const body = { null: request.null };
      return apiClient.post(endpoint, body) as unknown as CancelJobResponse;
    },
