...
// Generated at: 2026-02-25T09:28:17.713Z
...
export const api = {
  ...
  import: {
     ...
     */
    async uploadStatementFile(request: UploadStatementFileRequest): Promise<UploadStatementFileResponse> {
      return apiClient.post(`/api/v1/import/upload`, request) as unknown as UploadStatementFileResponse;
    },
     ...
     */
    async parseStatement(request: ParseStatementRequest): Promise<ParseStatementResponse> {
      return apiClient.post(`/api/v1/import/parse`, request) as unknown as ParseStatementResponse;
    },
    ...
    async convertCurrency(request: ConvertCurrencyRequest): Promise<ConvertCurrencyResponse> {
      return apiClient.post(`/api/v1/import/convert-currency`, request) as unknown as ConvertCurrencyResponse;
    },
     ...
     */
    async detectDuplicates(request: DetectDuplicatesRequest): Promise<DetectDuplicatesResponse> {
      return apiClient.post(`/api/v1/import/detect-duplicates`, request) as unknown as DetectDuplicatesResponse;
    },
     ...
     */
    async executeImport(request: ExecuteImportRequest): Promise<ExecuteImportResponse> {
      return apiClient.post(`/api/v1/import/execute`, request) as unknown as ExecuteImportResponse;
    },
     ...
     */
    async listBankTemplates(request: ListBankTemplatesRequest): Promise<ListBankTemplatesResponse> {
      function toQueryParams(obj: any, parentKey = ''): string {
        const params: string[] = [];
        for (const [key, value] of Object.entries(obj)) {
          if (value === undefined || value === null) continue;
      ...
      const queryString = request ? toQueryParams(request) : '';
      const endpoint = `/api/v1/import/templates${queryString ? `?${queryString}` : ""}`;
      return apiClient.get(endpoint) as unknown as ListBankTemplatesResponse;
    },
     ...
     */
    async getImportHistory(request: GetImportHistoryRequest): Promise<GetImportHistoryResponse> {
      function toQueryParams(obj: any, parentKey = ''): string {
        const params: string[] = [];
        for (const [key, value] of Object.entries(obj)) {
          if (value === undefined || value === null) continue;
      ...
      const queryString = request ? toQueryParams(request) : '';
      const endpoint = `/api/v1/import/history${queryString ? `?${queryString}` : ""}`;
      return apiClient.get(endpoint) as unknown as GetImportHistoryResponse;
    },
     ...
     */
    async undoImport(request: UndoImportRequest): Promise<UndoImportResponse> {
      const endpoint = `/api/v1/import/${request.importId}/undo`;
      return apiClient.post(endpoint, {}) as unknown as UndoImportResponse;
    },
     ...
     */
    async listExcelSheets(request: ListExcelSheetsRequest): Promise<ListExcelSheetsResponse> {
      const endpoint = `/api/v1/import/excel-sheets/${request.fileId}`;
      return apiClient.get(endpoint) as unknown as ListExcelSheetsResponse;
    },
     ...
     */
    async createUserTemplate(request: CreateUserTemplateRequest): Promise<CreateUserTemplateResponse> {
      return apiClient.post(`/api/v1/import/user-templates`, request) as unknown as CreateUserTemplateResponse;
    },
    ...
    async listUserTemplates(request: ListUserTemplatesRequest): Promise<ListUserTemplatesResponse> {
      ...
      const queryString = request ? toQueryParams(request) : '';
      const endpoint = `/api/v1/import/user-templates${queryString ? `?${queryString}` : ""}`;
      return apiClient.get(endpoint) as unknown as ListUserTemplatesResponse;
    },
    ...
    async getUserTemplate(request: GetUserTemplateRequest): Promise<GetUserTemplateResponse> {
      const endpoint = `/api/v1/import/user-templates/${request.templateId}`;
      return apiClient.get(endpoint) as unknown as GetUserTemplateResponse;
    },
     ...
     */
    async updateUserTemplate(request: UpdateUserTemplateRequest): Promise<UpdateUserTemplateResponse> {
      const endpoint = `/api/v1/import/user-templates/${request.templateId}`;
      return apiClient.put(endpoint, request) as unknown as UpdateUserTemplateResponse;
    },
     ...
     */
    async deleteUserTemplate(request: DeleteUserTemplateRequest): Promise<DeleteUserTemplateResponse> {
      const endpoint = `/api/v1/import/user-templates/${request.templateId}`;
      return apiClient.delete(endpoint) as unknown as DeleteUserTemplateResponse;
    },
    ...
    async getJobStatus(request: GetJobStatusRequest): Promise<GetJobStatusResponse> {
      const endpoint = `/api/v1/import/jobs/${request.jobId}`;
      return apiClient.get(endpoint) as unknown as GetJobStatusResponse;
    },
    ...
    async cancelJob(request: CancelJobRequest): Promise<CancelJobResponse> {
      const endpoint = `/api/v1/import/jobs/${request.jobId}/cancel`;
      return apiClient.post(endpoint, {}) as unknown as CancelJobResponse;
    },
     ...
     */
    async listUserJobs(request: ListUserJobsRequest): Promise<ListUserJobsResponse> {
      function toQueryParams(obj: any, parentKey = ''): string {
        const params: string[] = [];
        for (const [key, value] of Object.entries(obj)) {
          if (value === undefined || value === null) continue;
      ...
      const queryString = request ? toQueryParams(request) : '';
      const endpoint = `/api/v1/import/jobs${queryString ? `?${queryString}` : ""}`;
      return apiClient.get(endpoint) as unknown as ListUserJobsResponse;
    },
  ...
  investment: {
     ...
     */
    async getMarketPrices(request: GetMarketPricesRequest): Promise<GetMarketPricesResponse> {
      function toQueryParams(obj: any, parentKey = ''): string {
        const params: string[] = [];
        for (const [key, value] of Object.entries(obj)) {
          if (value === undefined || value === null) continue;
      ...
      const queryString = request ? toQueryParams(request) : '';
      const endpoint = `/api/v1/investments/market-prices${queryString ? `?${queryString}` : ""}`;
      return apiClient.get(endpoint) as unknown as GetMarketPricesResponse;
    },
