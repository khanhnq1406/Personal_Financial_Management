...
export interface InvestmentPerformance {
  ...
  unrealizedPnl: number;
  unrealizedPnlPercent: number;
  displayUnrealizedPnl: Money | undefined;
  displayCurrency: string;
}
...
export interface GetHistoricalPortfolioValuesRequest {
  /** 0 or omitted = all investment wallets */
  walletId: number;
  /** Optional filter by investment type */
  typeFilter: InvestmentType;
  /** Number of days of history (default: 30, max: 365) */
  days: number;
  /** Number of data points to return (default: 10, max: 100) */
  points: number;
}

/** GetHistoricalPortfolioValuesResponse with historical portfolio values */
export interface GetHistoricalPortfolioValuesResponse {
  success: boolean;
  message: string;
...
export const PortfolioSummary: MessageFns<PortfolioSummary> = {
  encode(message: PortfolioSummary, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.topPerformers) {
      InvestmentPerformance.encode(v!, writer.uint32(130).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 16: {
          ...
          message.topPerformers.push(InvestmentPerformance.decode(reader, reader.uint32()));
          continue;
        }
        case 17: {
          if (tag !== 138) {
  ...
  fromJSON(object: any): PortfolioSummary {
    return {
      ...
      displayUnrealizedPnl: isSet(object.displayUnrealizedPnl)
        ...
        : undefined,
      displayCurrency: isSet(object.displayCurrency) ? globalThis.String(object.displayCurrency) : "",
      topPerformers: globalThis.Array.isArray(object?.topPerformers)
        ? object.topPerformers.map((e: any) => InvestmentPerformance.fromJSON(e))
        : [],
  ...
  toJSON(message: PortfolioSummary): unknown {
    ...
    if (message.topPerformers?.length) {
      obj.topPerformers = message.topPerformers.map((e) => InvestmentPerformance.toJSON(e));
    }
...
function createBaseInvestmentPerformance(): InvestmentPerformance {
  return {
    investmentId: 0,
    symbol: "",
    name: "",
...
export const InvestmentPerformance: MessageFns<InvestmentPerformance> = {
  encode(message: InvestmentPerformance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.investmentId !== 0) {
    ...
    if (message.unrealizedPnl !== 0) {
      writer.uint32(40).int64(message.unrealizedPnl);
    }
    if (message.unrealizedPnlPercent !== 0) {
      writer.uint32(49).double(message.unrealizedPnlPercent);
    }
    if (message.displayUnrealizedPnl !== undefined) {
      Money.encode(message.displayUnrealizedPnl, writer.uint32(58).fork()).join();
    }
    if (message.displayCurrency !== "") {
      writer.uint32(66).string(message.displayCurrency);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): InvestmentPerformance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInvestmentPerformance();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): InvestmentPerformance {
    return {
      investmentId: isSet(object.investmentId) ? globalThis.Number(object.investmentId) : 0,
      symbol: isSet(object.symbol) ? globalThis.String(object.symbol) : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
  ...
  toJSON(message: InvestmentPerformance): unknown {
    const obj: any = {};
    if (message.investmentId !== 0) {
      obj.investmentId = Math.round(message.investmentId);
    }
  ...
  create(base?: DeepPartial<InvestmentPerformance>): InvestmentPerformance {
    return InvestmentPerformance.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<InvestmentPerformance>): InvestmentPerformance {
    const message = createBaseInvestmentPerformance();
    message.investmentId = object.investmentId ?? 0;
    message.symbol = object.symbol ?? "";
    message.name = object.name ?? "";
...
function createBaseHistoricalPortfolioValue(): HistoricalPortfolioValue {
  return { timestamp: 0, totalValue: 0, displayTotalValue: undefined };
}

export const HistoricalPortfolioValue: MessageFns<HistoricalPortfolioValue> = {
  encode(message: HistoricalPortfolioValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.displayTotalValue !== undefined) {
      Money.encode(message.displayTotalValue, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): HistoricalPortfolioValue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHistoricalPortfolioValue();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): HistoricalPortfolioValue {
    return {
  ...
  toJSON(message: HistoricalPortfolioValue): unknown {
    const obj: any = {};
    if (message.timestamp !== 0) {
  ...
  create(base?: DeepPartial<HistoricalPortfolioValue>): HistoricalPortfolioValue {
    return HistoricalPortfolioValue.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HistoricalPortfolioValue>): HistoricalPortfolioValue {
    const message = createBaseHistoricalPortfolioValue();
...
function createBaseGetHistoricalPortfolioValuesRequest(): GetHistoricalPortfolioValuesRequest {
  return { walletId: 0, typeFilter: 0, days: 0, points: 0 };
}

export const GetHistoricalPortfolioValuesRequest: MessageFns<GetHistoricalPortfolioValuesRequest> = {
  encode(message: GetHistoricalPortfolioValuesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.walletId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetHistoricalPortfolioValuesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetHistoricalPortfolioValuesRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetHistoricalPortfolioValuesRequest {
    return {
      walletId: isSet(object.walletId) ? globalThis.Number(object.walletId) : 0,
  ...
  toJSON(message: GetHistoricalPortfolioValuesRequest): unknown {
    const obj: any = {};
    if (message.walletId !== 0) {
      obj.walletId = Math.round(message.walletId);
    }
  ...
  create(base?: DeepPartial<GetHistoricalPortfolioValuesRequest>): GetHistoricalPortfolioValuesRequest {
    return GetHistoricalPortfolioValuesRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetHistoricalPortfolioValuesRequest>): GetHistoricalPortfolioValuesRequest {
    const message = createBaseGetHistoricalPortfolioValuesRequest();
    message.walletId = object.walletId ?? 0;
...
function createBaseGetHistoricalPortfolioValuesResponse(): GetHistoricalPortfolioValuesResponse {
  return { success: false, message: "", data: [], timestamp: "" };
}

export const GetHistoricalPortfolioValuesResponse: MessageFns<GetHistoricalPortfolioValuesResponse> = {
  encode(message: GetHistoricalPortfolioValuesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.data) {
      HistoricalPortfolioValue.encode(v!, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetHistoricalPortfolioValuesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetHistoricalPortfolioValuesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.data.push(HistoricalPortfolioValue.decode(reader, reader.uint32()));
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): GetHistoricalPortfolioValuesResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      message: isSet(object.message) ? globalThis.String(object.message) : "",
      data: globalThis.Array.isArray(object?.data)
        ? object.data.map((e: any) => HistoricalPortfolioValue.fromJSON(e))
        : [],
      timestamp: isSet(object.timestamp) ? globalThis.String(object.timestamp) : "",
    };
  },

  toJSON(message: GetHistoricalPortfolioValuesResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
    ...
    if (message.data?.length) {
      obj.data = message.data.map((e) => HistoricalPortfolioValue.toJSON(e));
    }
    if (message.timestamp !== "") {
  ...
  create(base?: DeepPartial<GetHistoricalPortfolioValuesResponse>): GetHistoricalPortfolioValuesResponse {
    return GetHistoricalPortfolioValuesResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetHistoricalPortfolioValuesResponse>): GetHistoricalPortfolioValuesResponse {
    const message = createBaseGetHistoricalPortfolioValuesResponse();
    message.success = object.success ?? false;
    message.message = object.message ?? "";
    message.data = object.data?.map((e) => HistoricalPortfolioValue.fromPartial(e)) || [];
