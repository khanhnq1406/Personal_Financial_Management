...
export interface CategoryBreakdownItem {
  ...
  displayAmount: Money | undefined;
  transactionCount: number;
}

/** GetCategoryBreakdown response */
export interface GetCategoryBreakdownResponse {
  success: boolean;
  message: string;
...
export const Transaction: MessageFns<Transaction> = {
  encode(message: Transaction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.date !== 0) {
      writer.uint32(48).int64(message.date);
    }
    if (message.note !== "") {
...
function createBaseGetCategoryBreakdownRequest(): GetCategoryBreakdownRequest {
  return { startDate: 0, endDate: 0, walletIds: [], categoryType: undefined };
}

export const GetCategoryBreakdownRequest: MessageFns<GetCategoryBreakdownRequest> = {
  encode(message: GetCategoryBreakdownRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.categoryType !== undefined) {
      writer.uint32(32).int32(message.categoryType);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetCategoryBreakdownRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetCategoryBreakdownRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 4: {
          ...
          message.categoryType = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetCategoryBreakdownRequest {
    return {
      ...
      walletIds: globalThis.Array.isArray(object?.walletIds)
        ? object.walletIds.map((e: any) => globalThis.Number(e))
        : [],
      categoryType: isSet(object.categoryType) ? categoryTypeFromJSON(object.categoryType) : undefined,
    };
  },

  toJSON(message: GetCategoryBreakdownRequest): unknown {
    const obj: any = {};
    if (message.startDate !== 0) {
      obj.startDate = Math.round(message.startDate);
    }
    ...
    if (message.categoryType !== undefined) {
      obj.categoryType = categoryTypeToJSON(message.categoryType);
    }
    return obj;
  },

  create(base?: DeepPartial<GetCategoryBreakdownRequest>): GetCategoryBreakdownRequest {
    return GetCategoryBreakdownRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetCategoryBreakdownRequest>): GetCategoryBreakdownRequest {
    const message = createBaseGetCategoryBreakdownRequest();
    message.startDate = object.startDate ?? 0;
    message.endDate = object.endDate ?? 0;
    message.walletIds = object.walletIds?.map((e) => e) || [];
    message.categoryType = object.categoryType ?? undefined;
    return message;
  },
};

function createBaseCategoryBreakdownItem(): CategoryBreakdownItem {
  return {
    categoryId: 0,
    categoryName: "",
    type: 0,
...
export const CategoryBreakdownItem: MessageFns<CategoryBreakdownItem> = {
  encode(message: CategoryBreakdownItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.categoryId !== 0) {
      writer.uint32(8).int32(message.categoryId);
    }
    ...
    if (message.totalAmount !== undefined) {
      Money.encode(message.totalAmount, writer.uint32(34).fork()).join();
    }
    if (message.displayAmount !== undefined) {
      Money.encode(message.displayAmount, writer.uint32(42).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CategoryBreakdownItem {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCategoryBreakdownItem();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  toJSON(message: CategoryBreakdownItem): unknown {
    ...
    if (message.totalAmount !== undefined) {
      obj.totalAmount = Money.toJSON(message.totalAmount);
    }
    if (message.displayAmount !== undefined) {
      obj.displayAmount = Money.toJSON(message.displayAmount);
    }
  ...
  create(base?: DeepPartial<CategoryBreakdownItem>): CategoryBreakdownItem {
    return CategoryBreakdownItem.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CategoryBreakdownItem>): CategoryBreakdownItem {
    const message = createBaseCategoryBreakdownItem();
    message.categoryId = object.categoryId ?? 0;
...
function createBaseGetCategoryBreakdownResponse(): GetCategoryBreakdownResponse {
  return { success: false, message: "", categories: [], currency: "", timestamp: "" };
}

export const GetCategoryBreakdownResponse: MessageFns<GetCategoryBreakdownResponse> = {
  encode(message: GetCategoryBreakdownResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.message !== "") {
    ...
    for (const v of message.categories) {
      CategoryBreakdownItem.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.currency !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetCategoryBreakdownResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetCategoryBreakdownResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.categories.push(CategoryBreakdownItem.decode(reader, reader.uint32()));
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): GetCategoryBreakdownResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      message: isSet(object.message) ? globalThis.String(object.message) : "",
      categories: globalThis.Array.isArray(object?.categories)
        ? object.categories.map((e: any) => CategoryBreakdownItem.fromJSON(e))
        : [],
      currency: isSet(object.currency) ? globalThis.String(object.currency) : "",
      timestamp: isSet(object.timestamp) ? globalThis.String(object.timestamp) : "",
    };
  ...
  toJSON(message: GetCategoryBreakdownResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
    ...
    if (message.categories?.length) {
      obj.categories = message.categories.map((e) => CategoryBreakdownItem.toJSON(e));
    }
    if (message.currency !== "") {
      obj.currency = message.currency;
    }
  ...
  create(base?: DeepPartial<GetCategoryBreakdownResponse>): GetCategoryBreakdownResponse {
    return GetCategoryBreakdownResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetCategoryBreakdownResponse>): GetCategoryBreakdownResponse {
    const message = createBaseGetCategoryBreakdownResponse();
    message.success = object.success ?? false;
    message.message = object.message ?? "";
    message.categories = object.categories?.map((e) => CategoryBreakdownItem.fromPartial(e)) || [];
    message.currency = object.currency ?? "";
    message.timestamp = object.timestamp ?? "";
    return message;
  },
