...
function createBaseCreateWalletRequest(): CreateWalletRequest {
  return { walletName: "", initialBalance: undefined };
}
...
export const CreateWalletRequest = {
  encode(message: CreateWalletRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.initialBalance !== undefined) {
      Money.encode(message.initialBalance, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
...
export const WithdrawFundsRequest = {
  encode(message: WithdrawFundsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.walletId !== 0) {
      writer.uint32(8).int32(message.walletId);
    }
    if (message.amount !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WithdrawFundsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TransferFundsRequest = {
  encode(message: TransferFundsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TransferFundsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TransferFundsResponse = {
  encode(message: TransferFundsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.message !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TransferFundsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
