...
export const LoginData = {
  encode(message: LoginData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const LoginResponse = {
  encode(message: LoginResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.data !== undefined) {
      LoginData.encode(message.data, writer.uint32(26).fork()).ldelim();
    }
    if (message.timestamp !== "") {
      writer.uint32(34).string(message.timestamp);
    }
...
export const VerifyAuthResponse = {
  encode(message: VerifyAuthResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.message !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VerifyAuthResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetAuthResponse = {
  encode(message: GetAuthResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.message !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetAuthResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
